...
def split_documents(documents, chunk_size=1000, chunk_overlap=0):
    ...
    # print first 5 chuncks to see it visually
    if chunks:
...
def main():
    ...
    # Step 2: Split into chunks => list of smaller chunks # charektertestsplitter is the main method here
